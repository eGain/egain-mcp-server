...
**Important:**
- **PKCE-friendly client apps (SPAs) are strongly preferred** - Configure your client app as a Single Page Application (SPA) platform type for the best authentication experience.
