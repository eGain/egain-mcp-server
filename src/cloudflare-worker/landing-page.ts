        ...
        <div class="installation-method">
            ...
            <div class="method-content" id="claude-cli-content">
                ...
                <div class="code-container">
                    ...
                    <pre id="claude-cli">claude mcp add --transport http EgainMcp ${o}/mcp --header "authorization: ..." </pre>
                </div>
            </div>
        </div>
        <div class="installation-method">
            ...
            <div class="method-content" id="manual-content">
                ...
                <div class="code-container">
                    ...
                    <pre id="manual-install">npx egain-mcp start --server-index ... --api-domain ... --access-token ...</pre>
                </div>
