...
import {
  PostPortalIDRetrieveOpServerList,
...
> {
  ...
  const baseURL$ = options?.serverURL
    || pathToFunc(PostPortalIDRetrieveOpServerList[0], {
      charEncoding: "percent",
    })(
      {
        API_DOMAIN: "aiservices-qe.ezdev.net",
      },
    );
  ...
  >(
    ...
    M.nil(400, PostPortalIDRetrieveResponse$zodSchema),
    M.nil(500, PostPortalIDRetrieveResponse$zodSchema),
