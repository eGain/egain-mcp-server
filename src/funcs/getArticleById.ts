 ...
 *     - Never ask the user to provide the article ID if it can be discovered via aiSearch or getBestAnswer.
 *     - If article context is missing or unclear, call aiSearch or getBestAnswer and select the best match based on user's query.
 ...
 * ```json
 * {"request": {"portalID": "PZ-9999", "articleID": "PROD-2996", "acceptLanguage": "en-US"}}
 * ```
 *
