...
export function initHooks(hooks: Hooks) {
  ...
  // 1. Portal Cache Hook - caches portal names/IDs after authentication
  // Create this first so we can pass it to the auth hook
  ...
  // 3. Portal Lookup Hook - translates portal names to IDs in requests
