...
import { wrapInitializeWithVersionCheck } from "../../version-check-initialize.js";
...
async function startStdio(flags: StartCommandFlags) {
  ...
  wrapInitializeWithVersionCheck(server);
...
async function startSSE(cliFlags: StartCommandFlags) {
  ...
  app.get("/sse", async (req, res) => {
    ...
    wrapInitializeWithVersionCheck(mcpServer);
