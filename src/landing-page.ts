...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "args": [
      ...
      "--header",
      "o-auth-user:${O_AUTH_USER}",
      "--header",
      "o-auth-customer:${O_AUTH_CUSTOMER}",
      "--header",
      "o-auth-anonymous-customer:${O_AUTH_ANONYMOUS_CUSTOMER}",
      "--header",
      "access-token:${ACCESS_TOKEN}",
    ],
    "env": {
      "SERVER": "YOUR_VALUE_HERE",
      "API_DOMAIN": "YOUR_VALUE_HERE",
      "O_AUTH_USER": "YOUR_VALUE_HERE",
      "O_AUTH_CUSTOMER": "YOUR_VALUE_HERE",
      "O_AUTH_ANONYMOUS_CUSTOMER": "YOUR_VALUE_HERE",
      "ACCESS_TOKEN": "YOUR_VALUE_HERE",
    },
  };
  const codexConfig = `[mcp_servers.EgainMcp]
url = "${o}/sse"
http_headers = { "server" = "YOUR_SERVER", "api-domain" = "YOUR_API_DOMAIN", "o-auth-user" = "YOUR_O_AUTH_USER", "o-auth-customer" = "YOUR_O_AUTH_CUSTOMER", "o-auth-anonymous-customer" = "YOUR_O_AUTH_ANONYMOUS_CUSTOMER", "access-token" = "YOUR_ACCESS_TOKEN" }`;
...
<head>
    ...
    <meta name="description" content="Install @egain/egain-mcp-server MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@egain/egain-mcp-server - MCP Server">
    <meta property="og:description" content="Install @egain/egain-mcp-server MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@egain/egain-mcp-server - MCP Server">
    <meta property="twitter:description" content="Install @egain/egain-mcp-server MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@egain/egain-mcp-server</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=EgainMcp&config=">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=EgainMcp&config=">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=EgainMcp&config=">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add --transport sse EgainMcp undefined/sse</code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add --transport sse EgainMcp undefined/sse</code>
        </div>
      </div>
    </div>
